    ...
    ?>
      <div class="row">
        <div class="card">
          ...
          <div class="card-body" style="background-color:#D6EDEF">
            <div class="row">
              <div class="col-sm-2">
              ...
              <div class="row">
                <form method="POST" action="">
                  <div class="col-md-4">
                    <input type="date" class="form-control" id="datepicker" name="dari" autocomplete="off" placeholder="dari Tanggal">
                  </div>
                  <div class="col-md-4 mb-1">
                    <input type="date" class="form-control" id="datepicker2" name="sampai" autocomplete="off" placeholder="Sampai Tanggal">
                  </div>
                  <div class="col-md-4">
      ...
      ?>
        ...
        <div class="row">
          <div class="card">
            <div class="card-header">
              <h3>Ringkasan laba rugi (dibayar & belum dibayar) periode <?php echo $newdari; ?> sampai <?php echo $newsampai; ?></h3>
            </div>
            <div class="card-body" style="background-color:#D6EDEF">
        ...
        <div class="row">
          <div class="card">
            <div class="card-header">
              <h3>Detail</h3>&nbsp;&nbsp;<a href="labarugi?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?> " target="_blank" class="btn btn-success"><i class="bx bx-print"></i> Print</a>
            </div>
            <div class="col-lg-6">
              <div class="card-body">
                <table class="table">
