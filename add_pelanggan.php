              ...
              <div class="container-fluid">
                ...
                <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
                  <div class="box-body">
                    ...
                    <div class="row">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Tutor" maxlength="50" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group">
                        <label for="nohp" class="col-sm-3 control-label">Email:</label>
                        <div class="col-md-12">
                          <input type="email" class="form-control" id="email" name="email" value="<?php echo $email; ?>" placeholder="Email" maxlength="50" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mb-1">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <textarea class="form-control" rows="3" id="alamat" name="alamat" maxlength="255" placeholder="Masukan mapel yang di ajar" required><?php echo $alamat; ?></textarea>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" name="simpan" onclick="document.getElementById('Myform').submit();"><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
                  </div>
                  <!-- /.box-footer -->
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (mysqli_num_rows($result) > 0) {
                  if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') {
                    $sql1 = "update $tabeldatabase set nama='$nama',nohp='$nohp',alamat='$alamat',email='$email' where kode='$kode'";
                  ...
                  $sql2 = "insert into $tabeldatabase values( '$kode','$tgldaftar','$nama','$alamat','$nohp','$email','')";
