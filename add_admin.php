                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                            <div class="form-group">
                              ...
                              <div class="col-md-12">
                                <input type="date" class="form-control pull-right" id="datepicker" name="tgllahir" placeholder="Masukan Tanggal Lahir" value="<?php echo $tgllahir; ?>">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="form-group">
                              ...
                              <div class="col-md-12">
                                <input type="date" class="form-control pull-right" id="datepicker2" name="tglaktif" placeholder="Masukan Tanggal Aktif" value="<?php echo $tglaktif; ?>">
                              </div>
                            </div>
                          </div>
