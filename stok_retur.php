    ...
    if (isset($_POST["simpan"])) {
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($retur > 0) {
          ...
          $sql = "UPDATE barang SET sisa='$sisaakhir',retur='$returakhir' where kode='$kode' ";
          $updt = mysqli_query($conn, $sql);

          if ($updt) {
            echo "<script type='text/javascript'>  alert('Berhasil, Barang hasil retur telah dipindahkan ke Stok Gudang!');</script>";
          } else {
            echo "<script type='text/javascript'>  alert('GAGAL, Terjadi kesalahan! Periksa kembali data yang dimasukan');</script>";
          }
        } else {
          echo "<script type='text/javascript'>  alert('GAGAL, jumlah barang yang akan dipindah harus lebih besar dari 0!');</script>";
        }
      }
    }
    ?>
