              ...
              <div class="card-body">
                <form class="row g-3" method="get" action="">
                  ...
                  <div class="row mt-1 justify-content-end">
                    <button type="submit" name="find" class="col-sm-2 btn btn-primary btn-sm">Filter</button>
                  </div>
                </form>
              </div>
            </div>
...
<section class="col-lg-12 connectedSortable">
  ...
  <div class="card" id="tabel1">
    <div class="card-header">
      <h3 class="card-title">Data Pembelian Periode: <?php echo $dari; ?> - <?php echo $sampe; ?></h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <?php
