        ...
        <ul class="sidebar-menu">
            ...
            if ($chmenu5 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="hutang_beli"><i class="fa fa-circle-o"></i>Hutang pembelian</a>
                        </li>
                        <li>
            ...
            if ($chmenu6 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="add_jual"><i class="fa fa-circle-o"></i>Trx Retail</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="rekening"><i class="fa fa-circle-o"></i>Rekening Saya</a>
                        </li>
            ...
            if ($chmenu8 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="stok_in"><i class="fa fa-circle-o"></i>Stok Masuk</a>
                        </li>
                        <li>
                            <a href="stok_out"><i class="fa fa-circle-o"></i>Stok Keluar</a>
                        </li>
                        <li>
            ...
            if ($chmenu9 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="report_jual"><i class="fa fa-circle-o"></i>Penjualan Retail</a>
                        </li>
                        <li>
