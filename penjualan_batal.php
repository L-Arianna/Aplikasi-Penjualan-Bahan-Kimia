...
<div class="page-wrapper">
  <div class="page-content">
    ...
    $halaman = "penjualan_batal"; // halaman
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            $sql    = "select * from invoicejual where nota ='$q' order by no";

            $sum = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(hargaakhir) as sub FROM invoicejual WHERE nota='$q'"));
            ...
            <div class="card-body">
              ...
              <p>Membatalkan Transaksi bisa beresiko membuat data penjualan/pembayaran atau data laporan menjadi tidak sesuai</p>
