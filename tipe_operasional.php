...
<div class="page-wrapper">
  <div class="page-content">
    ...
    $halaman = "tipe_operasional"; // halaman
                  ...
                  <div class="box-body">
                    ...
                    <div class="row mb-1">
                      <div class="form-group col-md-6 col-xs-12">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Nama Tipe Pengeluaran" maxlength="50">
                        </div>
                      </div>
                    </div>
              ...
              if (isset($_POST["simpan"])) {
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<script type='text/javascript'>  alert('Tipe Pengeluaran dengan nama yang sama sudah ada, silakan hapus dahulu untuk merubah!');</script>";
                  } else {
                    $sql2 = "insert into $tabeldatabase values( '$kode','$nama','')";
                    $insertan = mysqli_query($conn, $sql2);
                    echo "<script type='text/javascript'>  alert('Berhasil, Tipe Pengeluaran telah ditambahkan!');</script>";
                    echo "<script type='text/javascript'>window.location = '$halaman';</script>";
                  }
                }
              }
            ...
            <table class="table table-hover">
              ...
              <tr>
                ...
                ?>
                  ...
                  <td><button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='tipe_operasional?no=<?php echo $fill['no']; ?>'">Hapus</button></td>
              </tr>
            <?php } ?>
            </table>
          </div>
