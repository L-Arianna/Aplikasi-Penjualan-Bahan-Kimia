    ...
    ?>
                    ...
                    <div class="box-body">
                      <div class="row">
                        ...
                        <?php if ($status == 'belum') { ?>
                          ...
                          <div class="col-xs-6">
                            <p class="lead">Payment Due <?php echo $tglbayar; ?></p>
                      ...
                      <div class="row no-print">
                        <div class="col-md-10">
                          ...
                          <?php if ($status == 'belum') { ?>
                            ...
                            <button type="button" class="btn btn-success pull-right" data-bs-toggle="modal" data-bs-target="#bayar">Bayar</button>
                            <!-- Modal -->
                              ...
                              <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <button type="submit" name="save1" class="btn btn-primary">Simpan</button>
                                  </div>
                                </div>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-danger pull-right" data-bs-toggle="modal" data-bs-target="#exampleLargeModal">Hutang</button>
                            <!-- Modal -->
                                    ...
                                    <form method="post">
                                      ...
                                      <div class="row">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                            <input type="text" class="form-control" id="hutang" name="hutang1" value="<?php echo $totalprice; ?>" readonly>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                          ...
                          <?php } else if ($status == 'dibayar') { ?>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-success pull-right" data-bs-toggle="modal" data-bs-target="#exampleLargeModal">Pembayaran</button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleLargeModal" tabindex="-1" aria-hidden="true">
                              <div class="modal-dialog modal-md">
                                <div class="modal-content">
                          ...
                          <?php }
                          if (($status == 'dibayar' || $status == 'hutang') && ($terima == '' || $terima == null)) { ?>
                            <button type="button" class="btn btn-primary pull-right" onclick="window.location.href='diterima?nota=<?php echo $nota; ?>'">Diterima
                            </button>
                          <?php } ?>
                        </div>
                        <p>
      ...
      if (isset($_POST['hutang'])) {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $hutang = mysqli_real_escape_string($conn, $_POST['hutang1']);
          ...
          if ($jml >= $jml1) {
            ...
            $sqly = "UPDATE buy SET status='$status',tglsale='$due' where nota='$nota' ";
            $query1 = mysqli_query($conn, $sqly);
