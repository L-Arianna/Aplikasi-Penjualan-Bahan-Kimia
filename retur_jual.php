          ...
          if (isset($_POST["retur"])) {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                echo "<script type='text/javascript'>  alert('Jumlah Barang diretur tidak boleh lebih dari jumlah dijual!$retur');</script>";
              }
            }
          }
                          ...
                          <tr>
                            ...
                            <form action="retur_jual" method="post">
                              ...
                              <td><?php if ($fill['retur'] == "YES") { ?><p>Telah diretur</p><?php } else { ?>
                                  ...
                                  <input type="submit" value="Terima Retur" name="retur" class="btn btn-danger btn-small"> <?php } ?>
                              </td>
                            </form>
