                ...
                <div class="container-fluid">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo $halaman; ?>" id="Myform">
                    ...
                    <div class="box-footer">
                      <button type="submit" class="btn btn-primary pull-left btn-flat" name="simpan" onclick="document.getElementById('Myform').submit();"><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
                    </div>
                    <!-- /.box-footer -->
