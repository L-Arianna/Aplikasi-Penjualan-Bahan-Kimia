            ...
            <form method=post>
              ...
              <div class="card-footer">
                <div class="row justify-content-start">
                  <div class="col-md-2">
                    <button type="submit" class="btn btn-primary btn-sm" name="pay"><span class="bx bx-save"></span> Simpan</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="card">
            ...
            <form method=post>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col-md-2">
                    <button type="submit" class="btn btn-primary btn-sm" name="bank"><span class="bx bx-save"></span> Simpan</button>
                  </div>
                </div>
              </div>
          </div>
            ...
            <table class="table table-hover">
              ...
              <tr>
                ...
                ?>
                  ...
                  <td><button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='payment_options?no=<?php echo $fill['no']; ?>'">Hapus</button></td>
