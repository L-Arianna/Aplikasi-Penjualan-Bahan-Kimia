...
<div class="page-wrapper">
  <div class="page-content">
    ...
    ?>
        ...
        <div class="card-body">
          ...
          <div class="card-action">
            <form method="post" enctype="multipart/form-data">
              <a href="act_backup" class="btn btn-success btn-sm">DOWNLOAD </a>
            </form>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Restorasi Database</h3>
        </div>
        <div class="card-body">
          ...
          <div class="card-action">
            <a href="restore" class="btn btn-warning btn-sm">RESTORE DATABASE </a>
          </div>
        </div>
      </div>
  </div>
