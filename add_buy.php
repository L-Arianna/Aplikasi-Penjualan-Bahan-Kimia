...
function autoNumber()
{
  ...
  global $forward;
  $query = "SELECT MAX(RIGHT(nota, 4)) as max_id FROM buy ORDER BY nota";
                        ...
                        if ($supplier != '') {
                          if ($cek != '') {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              ...
                              $sql2 = "insert into $tabel values( '$kode','$tglnota','$datatotal','$supplier','$kasir','$keterangan','','$belum','')";
                              $insertan = mysqli_query($conn, $sql2);
                              $sql3 = "UPDATE mutasi SET status='$berhasil' where keterangan='$kode'";
                              $updatemutasi = mysqli_query($conn, $sql3);
                              echo "<script type='text/javascript'>  alert('Berhasil, Pembelian sukses dilakukan!'); </script>";
                            ...
                            echo "<script type='text/javascript'>  alert('Total Barang yang dibeli tidak boleh kosong');</script>";
                          }
                        } else {
                          echo "<script type='text/javascript'>  alert('Supplier belum dipilih!');</script>";
                        }
                      }
                    }
                    if ($kode == null || $kode == "") {
                    ...
                    <div id="main">
                      <div class="container-fluid">
                        <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform" class="form-user">
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <?php if ($chmod >= 4 || $_SESSION['jabatan'] == 'admin') { ?>
                                                <button type="button" class="btn btn-danger btn-xs" onclick="window.location.href='component/delete/delete_produk?get=<?php echo '2' . '&'; ?>barang=<?php echo $fill['kode'] . '&'; ?>jumlah=0&kode=<?php echo $kode . '&'; ?>no=<?php echo $fill['no'] . '&'; ?>forward=<?php echo $forward . '&'; ?>forwardpage=<?php echo "add_" . $forwardpage . '&'; ?>chmod=<?php echo $chmod; ?>'">Hapus</button>
                                              <?php } else {
                                              } ?>
                                            </td>
                                          </tr>
                          ...
                          <input type="hidden" value="<?php echo $datatotal; ?>" name="cek">
                          <!-- /.box-body -->
