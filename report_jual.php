        ...
        <div class="card radius-10 bg-danger bg-gradient">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <p class="mb-0 text-white">Total Trx Batal</p>
                <h4 class="my-1 text-white"><?php echo $data11; ?></h4>
              </div>
      ...
      <div class="col">
        <div class="card radius-10 bg-success bg-gradient">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <p class="mb-0 text-white">Total Trx Dibayar</p>
                <h4 class="my-1 text-white"><?php echo $data21; ?></h4>
              </div>
              <div class="text-white ms-auto font-35"><i class='bx bx-cart-alt'></i>
              </div>
            </div>
      ...
      <div class="col">
        <div class="card radius-10 bg-warning bg-gradient">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <p class="mb-0 text-white">Trx Berstatus Hutang</p>
                <h4 class="my-1 text-white"><?php echo $data31; ?></h4>
              </div>
              <div class="text-white ms-auto font-35"><i class='bx bx-cart-alt'></i>
              </div>
            </div>
      ...
      <div class="col">
        <div class="card radius-10 bg-primary bg-gradient">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <p class="mb-0 text-white">Trx telah diterima</p>
                <h4 class="my-1 text-white"><?php echo $data41; ?></h4>
              </div>
              <div class="text-white ms-auto font-35"><i class='bx bx-cart-alt'></i>
              </div>
            </div>
            ...
            <form class="form-horizontal" method="post" action="report_jual.php">
              <div class="row">
                ...
                <div class="col-sm-2">
                  ...
                  <button type="submit" name="filter" class="btn btn-info btn-sm">Filter</button>
                </div>
        ...
        ?>
          ...
          <div class="card" id="tabel1">
            ...
            <div class="card-header">
              <h3 class="card-title">Data <?php echo $dataapa ?> <span class="no-print label label-default" id="no-print"><?php echo $totaldata; ?></span>
              </h3>
            </div>
                  ...
                  ?>
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <?php if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') { ?>
                                  <button type="button" class="btn btn-info btn-sm no-print" onclick="window.location.href='stok_detail?id=1&trx=1&nota=<?php echo $fill['nota']; ?>'">Detail</button>
                                <?php } else {
                                } ?>
